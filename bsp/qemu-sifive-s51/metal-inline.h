...
/* --------------------- sifive_rtc0 ------------ */
extern inline unsigned long __metal_driver_sifive_rtc0_control_base(const struct metal_rtc *const rtc);
extern inline unsigned long __metal_driver_sifive_rtc0_control_size(const struct metal_rtc *const rtc);
extern inline struct metal_interrupt * __metal_driver_sifive_rtc0_interrupt_parent(const struct metal_rtc *const rtc);
extern inline int __metal_driver_sifive_rtc0_interrupt_line(const struct metal_rtc *const rtc);
extern inline struct metal_clock * __metal_driver_sifive_rtc0_clock(const struct metal_rtc *const rtc);
